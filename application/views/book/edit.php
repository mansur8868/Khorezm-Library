    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Редактировать книги</h3>
            </div>
			...
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="booktypes_id" class="form-control">
								...
								{
									$selected = ($booktype['id'] == $book['booktypes_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="publishdate" value="<?php echo ($this->input->post('publishdate') ? $this->input->post('publishdate') : $book['publishdate']); ?>" class="has-datepicker form-control" id="publishdate" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="publishhouse" value="<?php echo ($this->input->post('publishhouse') ? $this->input->post('publishhouse') : $book['publishhouse']); ?>" class="form-control" id="publishhouse" />
