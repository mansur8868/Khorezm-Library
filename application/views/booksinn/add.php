    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Добавить номер книги</h3>
            </div>
            <?php echo form_open('booksinn/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="books_id" class="form-control">
								...
								{
									$selected = ($book['id'] == $this->input->post('books_id')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="inn" value="<?php echo $this->input->post('inn'); ?>" class="form-control" id="inn" />
