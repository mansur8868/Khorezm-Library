			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="passport" value="<?php echo ($this->input->post('passport') ? $this->input->post('passport') : $user['passport']); ?>" class="form-control" id="passport" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="birthdate" value="<?php echo ($this->input->post('birthdate') ? $this->input->post('birthdate') : $user['birthdate']); ?>" class="has-datepicker form-control" id="birthdate" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="tel" value="<?php echo ($this->input->post('tel') ? $this->input->post('tel') : $user['tel']); ?>" class="form-control" id="tel" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="educationorwork" value="<?php echo ($this->input->post('educationorwork') ? $this->input->post('educationorwork') : $user['educationorwork']); ?>" class="form-control" id="educationorwork" />
						</div>
					</div>
				</div>
			</div>
